...
public class DoorLockTask extends AsyncTask<Auth,Void,String> {
	private static final String url_form = "http://%s/lock";
	private DoorStatusListener listener = null;
	private URL url = null;
	private Exception exception = null;

	public DoorLockTask( DoorStatusListener listener, String host){
